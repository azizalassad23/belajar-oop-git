...
window.MATERI[14] = {
  waktuMenit: 20,
  konten: "<div class=\"stub-note\">\n  <strong>📝 Materi ini masih kerangka (stub) — siap Anda isi.</strong>\n  Ganti bagian di bawah dengan penjelasan Anda. Struktur di bawah hanyalah template.\n  Edit file: <code>data/pertemuan/p14.js</code>\n</div>\n\n<h2>🎯 Tujuan Pembelajaran</h2>\n<ul>\n  <li>Memahami konsep: <strong>Constructor Overloading & Default Argument</strong>.</li>\n  <li>(Tambahkan tujuan spesifik lain di sini.)</li>\n</ul>\n\n<h2>📖 Materi</h2>\n<p>Beberapa cara membuat objek dari satu class. <em>(Tuliskan penjelasan lengkap di sini.)</em></p>\n<h3>Sub-bagian</h3>\n<p>Isi penjelasan…</p>\n\n<h2>💻 Contoh Kode</h2>\n<pre><code>#include &lt;iostream&gt;\nusing namespace std;\n\nint main() {\n    // Contoh kode untuk materi \"Constructor Overloading & Default Argument\"\n    return 0;\n}</code></pre>\n\n<div class=\"callout tip\"><strong>💡 Tips Mengajar</strong>\nTambahkan analogi atau kesalahan umum siswa di bagian ini.</div>\n\n<h2>📌 Rangkuman</h2>\n<ul><li>Poin kunci 1…</li><li>Poin kunci 2…</li></ul>",
  soal: [
    {
      "judul": "Latihan Pemanasan (placeholder)",
      "deskripsi": "<p>Ini soal contoh bawaan. <strong>Ganti dengan soal asli</strong> untuk materi <em>Constructor Overloading & Default Argument</em>.</p><p>Tugas: cetak tepat tulisan <code>Pertemuan 14 siap!</code></p>",
      "starter": "#include <iostream>\nusing namespace std;\n\nint main() {\n    // Tulis kode Anda di sini\n    \n    return 0;\n}\n",
      "expected": "Pertemuan 14 siap!",
      "petunjuk": "Gunakan <code>cout &lt;&lt; \"Pertemuan 14 siap!\";</code>"
    }
  ]
};
