...
window.KURIKULUM = {
  ...
  pertemuan: [
    ...
    { id: 17, modul: 3, judul: "Operator Overloading", ringkas: "Membuat +, ==, dan << bisa dipakai untuk objek buatan sendiri.", status: "ready" },

    { id: 18, modul: 4, judul: "Konsep Inheritance", ringkas: "Class anak mewarisi atribut dan method dari class induknya.", status: "ready" },
    { id: 19, modul: 4, judul: "Mode Akses Pewarisan", ringkas: "Beda hasilnya kalau mewarisi secara public, protected, atau private.", status: "ready" },
    { id: 20, modul: 4, judul: "Constructor & Destructor pada Inheritance", ringkas: "Siapa yang dipanggil lebih dulu antara class induk dan class anak.", status: "ready" },
    { id: 21, modul: 4, judul: "Overriding Method", ringkas: "Mengganti isi method warisan dengan versi buatan sendiri.", status: "ready" },
    { id: 22, modul: 4, judul: "Multilevel & Hierarchical Inheritance", ringkas: "Pewarisan bertingkat dan pewarisan yang bercabang.", status: "ready" },
    { id: 23, modul: 4, judul: "Multiple Inheritance & Diamond Problem", ringkas: "Mewarisi dari lebih dari satu induk, plus masalah yang sering muncul.", status: "ready" },

    { id: 24, modul: 5, judul: "Konsep Polymorphism", ringkas: "Perintah yang sama, tapi wujud perilakunya bisa berbeda-beda.", status: "ready" },
    { id: 25, modul: 5, judul: "Function Overloading vs Overriding", ringkas: "Dua hal yang mirip tapi beda: ditentukan saat compile atau saat program jalan.", status: "ready" },
    { id: 26, modul: 5, judul: "Virtual Function & Dynamic Binding", ringkas: "Kunci utama polymorphism saat program sedang berjalan.", status: "ready" },
    { id: 27, modul: 5, judul: "Pure Virtual & Abstract Class", ringkas: "Class yang sengaja dibuat supaya tidak bisa langsung dijadikan objek.", status: "ready" },
    { id: 28, modul: 5, judul: "Interface dengan Abstract Class", ringkas: "Menetapkan daftar method yang wajib dipunyai setiap class turunan.", status: "ready" },
    { id: 29, modul: 5, judul: "Virtual Destructor", ringkas: "Mencegah memori bocor saat objek dihapus lewat pointer induk.", status: "ready" },

    { id: 30, modul: 6, judul: "Templates (Function & Class Template)", ringkas: "Menulis satu kode yang bisa dipakai untuk banyak tipe data sekaligus.", status: "ready" },
    { id: 31, modul: 6, judul: "Exception Handling", ringkas: "Menangani error pakai try, catch, dan throw supaya program tidak langsung mati.", status: "ready" },
    { id: 32, modul: 6, judul: "STL Dasar: vector & string", ringkas: "Memakai vector dan string bawaan C++ biar tidak perlu bikin dari nol.", status: "ready" },
    { id: 33, modul: 6, judul: "Smart Pointer & Manajemen Memori", ringkas: "unique_ptr, shared_ptr, dan cara aman mengatur pemakaian memori.", status: "ready" },

    { id: 34, modul: 7, judul: "Studi Kasus: Merancang Sistem OOP", ringkas: "Menggabungkan semua materi jadi satu mini-project.", status: "ready" },
    { id: 35, modul: 7, judul: "Finalisasi & Presentasi Proyek", ringkas: "Merapikan, menguji, lalu mempresentasikan hasil proyek kamu.", status: "ready" },
  ],
};
